...
def compute_flow(network, inputs):
    global f
    global initialize
    current_frame = inputs["input_image"]
    ...
    if initialize:
        ...
        objectOutput = tempfile.TemporaryFile()
        ...
        a = flowiz.convert_from_file(objectOutput)

        return {"output_image": a}


if __name__ == "__main__":
    runway.run(model_options={"checkpoint": "network-default.pytorch"})
